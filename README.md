# 🇮🇳 Velocity Hindi - Automated Facebook Reels Bot

**Automated Hindi learning content generator for social media**

Generates and posts 4x daily to Facebook, Instagram, and other platforms with:
- ✅ AI-generated Hindi phrases with English translations
- ✅ Professional text-to-speech (Edge TTS)
- ✅ Beautiful gradient backgrounds with text overlays
- ✅ Perfect audio-video synchronization
- ✅ Velocity Hindi branding
...
4. Wisdom (ज्ञान)
5. Happiness (खुशी)
6. Self Improvement (आत्म सुधार)
7. Gratitude (कृतज्ञता)
8. Friendship (दोस्ती)
9. Hope (उम्मीद)
10. Creativity (रचनात्मकता)
11. Inner Peace (आंतरिक शांति)
12. Confidence (आत्मविश्वास)
13. Perseverance (लगन)
14. Inspiration (प्रेरणा)
15. Positive Life (सकारात्मक जीवन)
16. Courage (साहस)
17. Kindness (दयालुता)
18. Patience (धैर्य)
19. Forgiveness (क्षमा)
20. Strength (ताकत)
21. Joy (खुशी)
22. Balance (संतुलन)
23. Growth (विकास)
24. Purpose (उद्देश्य)
25. Mindfulness (सचेतनता)
...
1. Go to Actions → "Velocity Hindi - Daily 4x Upload"
...
### 📝 Fonts Setup (Hindi/Devanagari Support)

**Windows**: No setup needed! Hindi fonts are built-in.

**GitHub Actions**: Fonts are automatically installed via workflow.

**macOS/Linux**: Install Hindi fonts:
```bash
# Ubuntu/Debian
...
See `FONTS_SETUP.md` for detailed font configuration.
...
- **Frame Rate:** 30 FPS
- **Audio:** Edge TTS (GuyNeural EN, SwarNeural HI)
...
- English + 500ms pause + Hindi timing preserved
...
- Distinct colors: Navy (EN) / Maroon (HI) / Gray (Pronunciation)
- Velocity Hindi branding on every frame
...
🇮🇳 Learn Hindi with Velocity Hindi! 🇮🇳
